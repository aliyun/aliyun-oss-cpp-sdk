...
VoidOutcome AlibabaCloud::OSS::OssClient::SetBucketPolicy(const SetBucketPolicyRequest& request) const
{
    return client_->SetBucketPolicy(request);
}

VoidOutcome AlibabaCloud::OSS::OssClient::DeleteBucketPolicy(const DeleteBucketPolicyRequest& request) const
{
...
GetBucketPolicyOutcome AlibabaCloud::OSS::OssClient::GetBucketPolicy(const GetBucketPolicyRequest& request) const
{
