...
protected:
    ...
    static void SetUpTestCase()
    {
        ...
        Client = std::make_shared<OssEncryptionClient>(Config::Endpoint, Config::AccessKeyId, Config::AccessKeySecret,
...
TEST_F(CryptoObjectTest, EncryptionMaterialsFunctionFailTest)
{
    ...
    auto client = std::make_shared<OssEncryptionClient>(Config::Endpoint, Config::AccessKeyId, Config::AccessKeySecret,
        ClientConfiguration(), std::make_shared<SimpleRSAEncryptionMaterials>(publicKey, privateKey),
        CryptoConfiguration());
...
TEST_F(CryptoObjectTest, DifferentEncryptionMaterialsTest)
{
    ...
    auto otherClient = std::make_shared<OssEncryptionClient>(Config::Endpoint, Config::AccessKeyId, Config::AccessKeySecret,
    ...
    auto otherClient2 = std::make_shared<OssEncryptionClient>(Config::Endpoint, Config::AccessKeyId, Config::AccessKeySecret,
        ClientConfiguration(), std::make_shared<SimpleRSAEncryptionMaterials>(publicKey, privateKey, description),
        CryptoConfiguration());
...
{
    auto otherClient = std::make_shared<OssClient>(Config::Endpoint, Config::AccessKeyId, Config::AccessKeySecret,
        ClientConfiguration());
...
TEST_F(CryptoObjectTest, CompatibilityTest)
{
    ...
    auto unencryptedClient = std::make_shared<OssClient>(Config::Endpoint, Config::AccessKeyId, Config::AccessKeySecret, conf);
    auto encryptedClient = std::make_shared<OssEncryptionClient>(Config::Endpoint, 
